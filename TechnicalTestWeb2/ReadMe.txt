...
- There were two errors, (1) was Microsoft.Net.Compilers was not installed. Updated it from the NuGet Solutions by right clicking on the Solution. The Shipment had some issue in the DataModel.CS file. Fixed it by using CTRL+ENTER.
